...
COMMENT ON COLUMN TB_DEPARTMENT.OPEN_Y IS '개설 여부';
...
CLASS_NO VARCHAR2(10) REFERENCES TB_CLASS(CLASS_NO) NOT NULL PRIMARY KEY,
PROFESSOR_NO VARCHAR2(10) REFERENCES TB_PROFESSOR(PROFESSOR_NO) NOT NULL PRIMARY KEY
);
-- =======================
